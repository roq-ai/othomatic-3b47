...
import { getBailiffById } from 'apiSdk/bailiffs';
import { BailiffInterface } from 'interfaces/bailiff';

function BailiffViewPage() {
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('bailiff', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/bailiffs/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="bailiff" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
