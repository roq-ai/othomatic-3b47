...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`OthoMatic`}</title>

        <meta
          name="description"
          content="OthoMatic - Transforming Bailiff Operations with Comprehensive ERP Solutions. Document Cases, Manage Contacts, Notes, and Financial Bookings Seamlessly."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`OthoMatic - Transforming Bailiff Operations with Comprehensive ERP Solutions. Document Cases, Manage Contacts, Notes, and Financial Bookings Seamlessly.`}
            </Text>
            <Box
