...
export function RenamedcaseListPage(props: RenamedcaseListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getRenamedcases({
        relations: ['user', 'case_booking.count', 'case_contacts.count', 'case_notes.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['number.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'principal_amount', header: 'Principal Amount', accessorKey: 'principal_amount' },
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('case_booking', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'case_booking',
          header: 'Case Booking',
          accessorKey: 'case_booking',
          cell: ({ row: { original: record } }: any) => record?._count?.case_booking,
        }
      : null,
    hasAccess('case_contacts', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'case_contacts',
          header: 'Case Contacts',
          accessorKey: 'case_contacts',
          cell: ({ row: { original: record } }: any) => record?._count?.case_contacts,
        }
      : null,
    hasAccess('case_notes', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'case_notes',
          header: 'Case Notes',
          accessorKey: 'case_notes',
          cell: ({ row: { original: record } }: any) => record?._count?.case_notes,
        }
      : null,
