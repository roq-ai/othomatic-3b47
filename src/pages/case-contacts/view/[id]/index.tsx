...
import { getCaseContactsById } from 'apiSdk/case-contacts';
import { CaseContactsInterface } from 'interfaces/case-contacts';

function CaseContactsViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('case_contacts', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/case-contacts/edit/${id}`} passHref legacyBehavior>
                    <Button
